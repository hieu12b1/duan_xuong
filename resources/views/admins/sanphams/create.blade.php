                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ma_san_pham" name="ma_san_pham"
                                                ...
                                                value="{{old('ma_san_pham')}}" placeholder="ma_san_pham">
                                            @error('ma_san_pham')
                                            <p class="text-danger">
                                                {{$message}}
                                            </p>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ten_san_pham" name="ten_san_pham"
                                                ...
                                                value="{{old('ten_san_pham')}}" placeholder="ten_san_pham">
                                            @error('ten_san_pham')
                                            <p class="text-danger">
                                                {{$message}}
                                            </p>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="gia_san_pham" name="gia_san_pham"
                                                ...
                                                value="{{old('gia_san_pham')}}" placeholder="gia_san_pham">
                                            @error('gia_san_pham')
                                            <p class="text-danger">
                                                {{$message}}
                                            </p>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="gia_khuyen_mai" name="gia_khuyen_mai"
                                                ...
                                                value="{{old('gia_khuyen_mai')}}" placeholder="gia_khuyen_mai">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="danh_muc_id"
                                                ...
                                                <option value="{{$item->id}}" {{old ('danh_muc_id')==$item->id ?
                                                    'selected' : '' }}>{{$item->ten_danh_muc}}</option>
                                                @endforeach
                                            </select>
                                            @error('danh_muc_id')
                                            <p class="text-danger">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="so_luong" name="so_luong"
                                                ...
                                                value="{{old('so_luong')}}" placeholder="so_luong">
                                            @error('so_luong')
                                            <p class="text-danger">
                                                {{$message}}
                                            </p>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="ngay_nhap" name="ngay_nhap"
                                                ...
                                                value="{{old('ngay_nhap')}}" placeholder="ngay_nhap">
                                            @error('ngay_nhap')
                                            <p class="text-danger">
                                                {{$message}}
                                            </p>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" id="mo_ta_ngan" name="mo_ta_ngan"
                                                ...
                                                value="{{old('mo_ta_ngan')}}" placeholder="mo_ta_ngan">
                                               </textarea>
                                            @error('mo_ta_ngan')
                                            <p class="text-danger">
                                                {{$message}}
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img src="" id="img_danh_muc" alt="ảnh sản phẩm"
                                                style="with:150px;display:none">
                                        </div>
