                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="product-large-slider">
                                ...
                                @foreach ($sanPham->hinh_anh_san_pham as $item)
                                <div class="pro-large-img img-zoom">
            ...
            <div class="col-12">
                <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                    ...
                    <div class="product-item">
                        <figure class="product-thumb">
                            <a href="product-details.html">
                                <img class="pri-img" src="{{asset ('assets/client/img/product/product-11.jpg')}}"
                                    alt="product">
                                <img class="sec-img" src="{{asset ('assets/client/img/product/product-8.jpg')}}"
                                    alt="product">
                            </a>
                    ...
                    <div class="product-item">
                        <figure class="product-thumb">
                            <a href="product-details.html">
                                <img class="pri-img" src="{{asset ('assets/client/img/product/product-12.jpg')}}"
                                    alt="product">
                                <img class="sec-img" src="{{asset ('assets/client/img/product/product-7.jpg')}}"
                                    alt="product">
                            </a>
                            <div class="product-badge">
                                <div class="product-label new">
                    ...
                    <div class="product-item">
                        <figure class="product-thumb">
                            <a href="product-details.html">
                                <img class="pri-img" src="{{asset ('assets/client/img/product/product-13.jpg')}}"
                                    alt="product">
                                <img class="sec-img" src="{{asset ('assets/client/img/product/product-6.jpg')}}"
                                    alt="product">
                            </a>
                            <div class="product-badge">
                                <div class="product-label new">
                    ...
                    <div class="product-item">
                        <figure class="product-thumb">
                            <a href="product-details.html">
                                <img class="pri-img" src="{{asset ('assets/client/img/product/product-14.jpg')}}"
                                    alt="product">
                                <img class="sec-img" src="{{asset ('assets/client/img/product/product-5.jpg')}}"
                                    alt="product">
                            </a>
                            <div class="product-badge">
                                <div class="product-label new">
                    ...
                    <div class="product-item">
                        <figure class="product-thumb">
                            <a href="product-details.html">
                                <img class="pri-img" src="{{asset ('assets/client/img/product/product-15.jpg')}}"
                                    alt="product">
                                <img class="sec-img" src="{{asset ('assets/client/img/product/product-4.jpg')}}"
                                    alt="product">
                            </a>
                            <div class="product-badge">
                                <div class="product-label new">
